...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "bg-accent inline-flex h-12 items-center justify-center rounded-base border-2 border-border p-1 text-black dark:border-darkBorder",
      className,
    )}
    {...props}
  />
